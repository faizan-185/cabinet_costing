              ...
              ress.forEach(k => {
                ...
                if(document.getElementById('is_quotation').checked)
                {
                  qout = `
                          <div style="display: flex; flex-direction: row; justify-content: space-between">
                                <h3 style="color: black">${res[0].name}</h3>
                                <div style="background-color: black; height: 30px; width: 100px; text-align: center; align-items: center; position: absolute; right: 0;">
                                    <p style="color: white; font-size: 13px; text-align: center; margin-top: 5px"><b>QUOTATION</b></p>
                                </div>
                            </div>
                        `
                ...
                else
                {
                  ...
                  total = `
                            ...
                            <div style="display: flex; flex-direction: column; width: 100px; text-align: left; margin-left: 10px">
                                <p style="color: black; font-size: 10px">${Intl.NumberFormat('en-US').format(document.getElementById('gross-amount').value)}</p>
                                <p style="color: black; font-size: 10px">${Intl.NumberFormat('en-US').format(document.getElementById('discount').value)}</p>
                                <p style="color: black; font-size: 10px; border-bottom: 1px solid black">${Intl.NumberFormat('en-US').format(document.getElementById('calculated-tax').value)}</p>
                ...
                if(k.id === document.getElementById('client-input').value)
                {
                  file_manager.loadFile(path.join(__dirname, '../db/terms.json'))
                      .then(obj => {
                        ...
                        keys.forEach(i => {
                          if(pricing[i].length>0 && i !== "pinfo")
                          {
                            ...
                            pricing[i].forEach((j, ind) => {
                              body += `
                                <tr style="padding-top: 3px; padding-bottom: 3px">
                                  <td style="width: 40px; color: black; font-size: 10px; padding-left: 3px; padding-top: 2px; padding-bottom: 2px" >${count}</td>
                                  <td style="padding-left: 3px; width: 100px; text-overflow: ellipsis; white-space: nowrap; font-size: 10px; overflow: hidden; color: black; ">${j.utility_text}</td>
                                  <td  style=" padding-left: 3px;width: 150px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; color: black; font-size: 10px;">${j.type_text}</td>
                                  <td  style=" padding-left: 3px;width: 70px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size: 10px; color: black; ">${j.code_text}</td>
                                  <td  style=" padding-left: 3px;text-overflow: ellipsis; white-space: nowrap; overflow: hidden; color: black; font-size: 10px; width: 35px; ">${j.qty}</td>
                                  <td  style="padding-left: 3px;width: 120px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size: 10px; color: black; ">${j.door_panel_text}</td>
                                  <td  style="width: 120px; padding-left: 3px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size: 10px; color: black;">${j.handler_text}</td>
                                  <td  style="width: 120px; padding-left: 3px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size: 10px; color: black;">${j.hardware_text}</td>
                                  <td  style="width: 120px; padding-left: 3px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size: 10px; color: black;">${j.shelves_text}</td>
                                  <td  style="width: 100px; padding-left: 3px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; font-size: 10px; color: black;">${Intl.NumberFormat('en-US').format(j.unit)}</td>
                                  <td style="width: 100px; padding-left: 3px; text-overflow: ellipsis; white-space: nowrap; overflow: hidden; color: black; font-size: 10px; ">${Intl.NumberFormat('en-US').format(j.total)}</td>
                                </tr>`;
                              count +=1
                            });
                          }
                        ...
                        let table = `
                                    <table style="font-size: 12px; color: black;">
                                        <thead style="background-color: darkgrey; padding-top: 5px; padding-bottom: 5px">
                                            <tr style="padding-top: 5px; padding-bottom: 5px">
                                                <th style=" font-weight: calc(500); font-size: 10px; text-align: center; border: 0.5px solid black; padding-top: 2px; padding-bottom: 2px">No.</th>
                                                <th style="font-weight: calc(500); font-size: 10px; text-align: center; border: 0.5px solid black; padding-top: 2px; padding-bottom: 2px">UTILITY</th>
                                                ...
                                                <th style="font-weight: calc(500); font-size: 10px; text-align: center; border: 0.5px solid black">UNIT PRICE</th>
                                                <th style="font-weight: calc(500); font-size: 10px; text-align: center; border: 0.5px solid black">TOTAL</th>
                                            </tr>
                                        </thead>
                                        <tbody style="border: 0.5px solid black">${body}</tbody>
                                    </table>
                   ...
                   <div style="display: flex; flex-direction: row; margin-bottom: 5px">
                        ...
                        <div style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; flex-direction: row; justify-content: space-between">
                                ...
                                <p style="color: black; font-size: 13px; position: absolute; right: 0">Date: ${document.getElementById('entry-date').valueAsDate.getDay()}-${document.getElementById('entry-date').valueAsDate.getMonth()}-${document.getElementById('entry-date').valueAsDate.getFullYear()}</p>
                            </div>

                            <div style="width: 100%; border-bottom: 2px solid grey; padding-bottom: 10px; margin-bottom: 10px"></div>
                            <div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: 1px">
                                <p style="color: black; width: 200px; font-size: 10px; font-family: 'Arial Narrow', Arial, sans-serif "><b>Client Name: </b>${k.name}</p>
                                <p style="color: black; width: 170px; font-size: 10px;"><b>Contact: </b> ${k.contact}</p>
                                <p style="color: black; width: 230px; font-size: 10px;"><b>Address: </b> ${k.address}</p>
                            </div>
                            <div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: 1px">
                                <p style="color: black; width: 200px; font-size: 10px;"><b>Pricing No: </b>${document.getElementById('pricing-no').value}</p>
                                <p style="color: black; width: 170px; font-size: 10px;"><b>Manual No. </b>${document.getElementById('manual-input').value}</p>
                                <p style="color: black; font-size: 10px; width: 230px"><b>Delivery Time: </b>${document.getElementById('delivery-days').value} working days</p>

                            </div>
                            <div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: 1px">
                                <p style="color: black; width: 200px; font-size: 10px;"><b>Product Type: </b>${document.getElementById('product-input').value}</p>
                                <p style="color: black; width: 170px; font-size: 10px;"><b>Carcass: </b> ${document.getElementById('carcass-input').value}</p>
                                <p style="color: black; width: 230px; font-size: 10px;"><b>Sales RP: </b>${document.getElementById('sales-input').value}</p>
                            </div>
                        </div>
                    </div>
                    ${table}
                    <div style="display: flex; flex-direction: row; justify-content: space-between">
                        <div style="display: flex; flex-direction: row; justify-content: space-between; margin-top: 30px">
                            <p style="color: black; font-size: 10px; width: 90px"><b>Authorized By: </b></p>
                            ______________
                            <p style="color: black; font-size: 10px; width: 120px; margin-left: 30px"><b>Customer Signature:</b></p>
                            ______________
                        </div>
                        <div style="float: right; margin-top: 5px; z-index: 999">
